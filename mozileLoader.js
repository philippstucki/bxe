...
// init some default eventhandlers
function mozile_loaded() {
	document.eDOMaddEventListener("toggleSourceMode",toggleSourceMode,false);
	document.eDOMaddEventListener("toggleTagMode",toggleTagMode,false);
	document.eDOMaddEventListener("save",__mozileDummySave,false);
}
